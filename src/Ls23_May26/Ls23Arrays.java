...
public class Ls23Arrays {
    public static void main(String[] args) { // main принимает массив, который содержит сти=ринги

        // old declaration - int myVariable[]
        ...
        int[] field;
        field = new int[10];// в массиве 10 целочисленных элементов - 10 мест для 10 кнег

        String[] fourSeasons = new String[]{"Vivaldi", "Chaikovskiy", "Piazzola"};
